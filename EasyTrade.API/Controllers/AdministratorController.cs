...
public class AdministratorController : ControllerBase
{
    ...
    [HttpGet("Coefficient")]
    public async Task<IActionResult> GetCoeficient([MaxLength(3)] [MinLength(3)] string? firstIso,
        [MaxLength(3)] [MinLength(3)] string? secondIso)
    {
        var c = await _coefficientsProvider.GetCoefficient(firstIso, secondIso);
        return Ok(c);
    }
